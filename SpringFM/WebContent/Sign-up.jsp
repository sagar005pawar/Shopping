...
<body class="container w3-container w3-center regn-body">
<%
...
%>
<center>
<form class="form-horizontal w3-card-4 w3-light-blue" action="/SpringFM/SignupCntl" name="loginForm" method="post" onsubmit='return(validation())'>
	<div class="productheading">User RegistratioN</div>
    ...
    <a class="btn btn-outline btn-primary" href="/SpringFM/">Login</a>
    <br><br>
</form>
</center>
</body>
