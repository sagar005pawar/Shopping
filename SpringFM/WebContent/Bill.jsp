...
<br />  
	...
	<h5>=============================================</h5>
		...
		<c:if test="${total.total != 0}">
 	    	<a href="/SpringFM/PrintBill" target="_parent" onclick="return confirm('Are you sure you want to Print-Bill & DONE Shopping?');" class="btn btn-outline btn-black">
	 	    	<span class="glyphicon glyphicon-print"></span> PAY-BILL
 	    	</a>
		</c:if>		
		
		<form action="/SpringFM/UserHomepage" method="post" target="_parent">
